...
As a Solutions Architect, which of the following options would you suggest to troubleshoot the issue?
...
****
.All Exam solutions that will be implemented
[%header,cols=2]
|===
|Description
|Stack
...
|Quarkus, Camel and TF to launch a new SQS queue, configuring a seconds ECS Task to read from it, IAM roles with ECS Task can assume in order to get access S3 buckets with taskRoleArn
|===
****
